<template>
  <div class="fixed left-0 top-0 w-screen h-screen flex flex-col overflow-auto">
    <UHeader class="flex top-0 left-0 w-full z-10 justify-between items-center p-3 bg-darkpurple">
